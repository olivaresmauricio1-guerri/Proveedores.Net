...
Partial Class frmTipoServicio
    ...
    Private Sub InitializeComponent()
        ...
        txtKmRecomendado = New TextBox()
        LblKmRecomendado = New Label()
        ...
        GroupBoxDatos.Controls.Add(txtKmRecomendado)
        GroupBoxDatos.Controls.Add(LblKmRecomendado)
        ...
        GroupBoxDatos.Size = New Size(606, 103)
        GroupBoxDatos.TabIndex = 5
        GroupBoxDatos.TabStop = False
        GroupBoxDatos.Text = "Datos de Tipo de Servicio"
        ' 
        ' txtKmRecomendado
        ' 
        txtKmRecomendado.Location = New Point(122, 56)
        txtKmRecomendado.Name = "txtKmRecomendado"
        txtKmRecomendado.Size = New Size(160, 23)
        txtKmRecomendado.TabIndex = 7
        ' 
        ' LblKmRecomendado
        ' 
        LblKmRecomendado.AutoSize = True
        LblKmRecomendado.Location = New Point(13, 60)
        LblKmRecomendado.Name = "LblKmRecomendado"
        LblKmRecomendado.Size = New Size(105, 15)
        LblKmRecomendado.TabIndex = 6
        LblKmRecomendado.Text = "Km Recomendado"
        ' 
        ' LblDescripcion
        ' 
        LblDescripcion.AutoSize = True
        LblDescripcion.Location = New Point(229, 30)
        ...
        TxtDescripcion.Location = New Point(304, 27)
        ...
        ' TxtCodigo
        ' 
        TxtCodigo.Location = New Point(122, 27)
        ...
        CmdAgregar.Location = New Point(136, 422)
        ...
        btnModificar.Location = New Point(217, 422)
        ...
        CmdBorrar.Location = New Point(298, 422)
        ...
        cmdAceptar.Location = New Point(379, 422)
        ...
        CmdCancelar.Location = New Point(460, 422)
        ...
        CmdSalir.Location = New Point(541, 422)
    ...
    Friend WithEvents txtKmRecomendado As TextBox
    Friend WithEvents LblKmRecomendado As Label
